...
import { FaCartPlus, FaEye, FaTrash } from "react-icons/fa";
...
export default function AdminOrder() {
    ...
    return (
        <div className="h-full p-6 relative bg-blue-50">
            ...
            <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 flex flex-col gap-4">
                <h2 className="text-xl font-semibold text-black">List Order</h2>
